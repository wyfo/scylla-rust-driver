...
async fn test_named_bind_markers() {
    ...
    let prepared = session
        ...
        .await
        .unwrap();
    let hashmap: HashMap<String, i32> = HashMap::from([
        ("pk".to_owned(), 7),
        ("v".to_owned(), 42),
        ("ck".to_owned(), 13),
    ]);
    ...
    let btreemap: BTreeMap<String, i32> = BTreeMap::from([
        ("ck".to_owned(), 113),
        ("v".to_owned(), 142),
        ("pk".to_owned(), 17),
    ]);
    ...
    let wrongmaps: Vec<HashMap<String, i32>> = vec![
        HashMap::from([
            ("pk".to_owned(), 7),
            ("fefe".to_owned(), 42),
            ("ck".to_owned(), 13),
        ]),
        HashMap::from([("pk".to_owned(), 7), ("ck".to_owned(), 13)]),
        HashMap::from([
            ("pk".to_owned(), 7),
            ("v".to_owned(), 42),
            ("ck".to_owned(), 13),
        ...
        HashMap::new(),
        HashMap::from([(
            "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx".to_owned(),
            7,
        )]),
    ];
